...
?>
    ...
    <div class="container-fluid bg-primary">
      ...
      <ul class="navbar-nav col-lg-6 justify-content-lg-center">
        <li class="nav-item position-relative">
          <a class="nav-link" aria-current="page" href="cart12.php"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
              <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5M3.102 4l1.313 7h8.17l1.313-7zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4m7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4m-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2m7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2" />
            </svg><span class="badge rounded-pill badge-notification bg-danger position-absolute" style="top: -5px; right: -10px;"><?php echo $cart_total; ?></span></a>
        </li>
        <li class="nav-item ps-4 position-relative">
          <a class="nav-link" aria-current="page" href="daftarkeinginan.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
            ...
            </svg><span class="badge rounded-pill badge-notification bg-danger position-absolute" style="top: -5px; right: -10px;"><?php echo $jumlah_wishlist; ?></span>
          </a>
        </li>
      </ul>
  ...
  <div class="d-flex align-items-center justify-content-center my-3">
    <form action="dashboardsearch.php" method="GET" class="input-group w-50 p-3">
      <input type="text" id="katakunci" name="search" placeholder="Search" class="form-control w-25 p-3 rounded-start-pill">
      <button type="submit" class="rounded-end-circle bg-transparent" style="border: 1px solid #ccc;">
        <img src="logo/1720750272_2_pencarian.png" alt="Search" class="img-fluid" width="40px" height="40px">
      </button>
    </form>
  </div>
<?php
